...
- Arrivo dell'ordine:
  - FINCHE non sentiamo il citofono OPPURE riceviamo una chiamata dal corriere:
    - restare in vigile attesa
  - QUANDO sentiamo il citofono OPPURE riceviamo una chiamata dal corriere:
...
- Consumazione:
  - poggiare la pizza sul tavolo
  - sedersi
  - aprire la scatola della pizza
  - mangiare la pizza:
    - FINCHE ci sono fette di pizza E abbiamo fame:
      - prendiamo un'altra fetta
    - SE non abbiamo più fame E ci sono ancora fette di pizza > mettere il cartone nel frigorifero
    - ALTRIMENTI SE non abbiamo più fette > buttare il cartone